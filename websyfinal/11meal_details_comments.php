...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $userLoggedIn) {
    if (isset($_POST['comment'])) {
        ...
        header("Location: meal_details.php?meal_id=$meal_id");
        exit();
...
<body>
    ...
    <div class="topnav">
        <a href="12user_profile.php"><i class="fa fa-fw fa-home"></i>Profile</a>
    ...
    <div class="meal-details-box">
        ...
        <button onclick="window.location.href='ratings.php?meal_id=<?php echo $meal_id; ?>'">Rate this Meal</button>
        <br><br>
